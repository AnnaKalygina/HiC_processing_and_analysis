...
1. The reference genome sequence in a .fasta format. Could be downloaded from the UCSC genome browser. The .fasta files for hg38, CHM13 and hg002 are available on cluster as specified in the [data_example folder](HiC_processing_and_analysis/data_example).
